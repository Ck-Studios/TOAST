      ...
      <Animated.View style={[styles.container, {opacity: this.state.fadeAnim}]}>
        ...
        <SafeAreaView style={styles.contentView}>
          ...
          <View style={[styles.textContainer,]}>
            <Image
              style={[styles.image, {marginLeft: 80,}]}
              color={'white'}
          ...
          <View style={styles.textContainer}>
            <Image
              style={styles.image}
              color={'white'}
              source={require('../../../../static/cloud_download.png')}/>
            <Text style={styles.text}>처음 등록한 과목은 모든 정보를 불러오기까지</Text>
            <Text style={styles.text}>최대 30분 가량 소요될 수 있습니다.</Text>
          </View>
          <View style={{height: height * 0.08}}/>
          <TouchableOpacity
            onPress={() => applicationStore.icampusPasringTutorial = false}
